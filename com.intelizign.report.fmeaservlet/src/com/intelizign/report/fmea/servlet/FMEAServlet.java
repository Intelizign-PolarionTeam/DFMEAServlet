...
import com.intelizign.report.fmea.impl.CreateLink;
...
public class FMEAServlet extends HttpServlet {
	...
	private FMEALinkService fmeaLinkService;

	public void init() throws ServletException {
		super.init();
		this.dfmeaService = new CreateFmeaWorkItem();
		this.fmeaLinkService = new CreateLink();
	}
		...
		try {
			...
			if (action != null) {
				...
				case "createWorkItem":
					...
					break;
				case "createLink":
					fmeaLinkService.createLink(req, resp);
					break;
				default:
